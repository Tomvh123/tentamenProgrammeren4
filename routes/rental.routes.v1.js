...
router.get('/:userid', function (req, res) {
    ...
    db.query('SELECT customer.customerfirst_name, rental.reantal_id FROM customer INNER JOIN rental ON customer.customer_id = rental.customer_id  WHERE customer.customer_id =?', [user_id], function(error, rows, fields) {
        if (error) {
