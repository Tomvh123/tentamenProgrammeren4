...
app.post('/api/v1/register', function(req, res) {
    ...
    db.query('INSERT INTO customer (store_id, first_name, last_name, email, address_id, active, create_date, username, password) VALUES ("?", "?", "?", "?", "?", "?", "?", "?", "?") ', [storeid, firstname, lastname, address, email, active, createdate, username, password], function(error, rows, fields) {
